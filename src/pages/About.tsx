...
const About: React.FC = () => {
    useSEO({
        title: 'About Us',
        description:
            'Infonix Solutions is a UK consulting firm specialising in software engineering, human resources, and financial strategy — bridging top-tier talent with cutting-edge technology.',
        path: '/about',
    });
            ...
            <section className="bg-background py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-4xl mx-auto text-center">
                    <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <h2 className="text-2xl sm:text-3xl font-serif font-bold text-primary mb-6">Our Mission</h2>
                        <p className="text-lg sm:text-xl text-primary/80 leading-relaxed mb-10">
